...
def seed_default_policies() -> None:
    defaults = [
        ...
        ("CPF - Email Alert", "CPF", "HIGH", "ALERT", "email", 25),
        ("CPF-like - Email Alert", "CPF_LIKE", "HIGH", "ALERT", "email", 30),
        ("CNPJ - Email Alert", "CNPJ", "HIGH", "ALERT", "email", 25),
        ("RG - Email Alert", "RG_BR", "HIGH", "ALERT", "email", 25),
        ("Passport - Email Alert", "PASSPORT", "HIGH", "ALERT", "email", 25),
        ("CNH - Email Alert", "CNH_BR", "HIGH", "ALERT", "email", 25),
        ("CNS - Email Alert", "CNS_BR", "CRITICAL", "ALERT", "email", 20),
        ("Email Address - Email Alert", "EMAIL_ADDRESS", "MEDIUM", "ALERT", "email", 40),
        ("Phone - Email Alert", "PHONE_BR", "MEDIUM", "ALERT", "email", 40),
        ("Bank Data - Email Alert", "BANK_ACCOUNT", "HIGH", "ALERT", "email", 20),
        ("PIX - Email Alert", "PIX_KEY", "HIGH", "ALERT", "email", 20),

        ("Card Data - Email Block", "CREDIT_CARD", "CRITICAL", "BLOCK", "email", 5),
        ("Card Security Code - Email Block", "CARD_SECURITY_CODE", "CRITICAL", "BLOCK", "email", 1),
        ("Card PIN - Email Block", "CARD_PIN", "CRITICAL", "BLOCK", "email", 1),
        ("Card Track Data - Email Block", "CARD_TRACK_DATA", "CRITICAL", "BLOCK", "email", 1),
        ("Secrets - Email Block", "SECRET", "CRITICAL", "BLOCK", "email", 5),
        ("Credentials - Email Block", "CREDENTIAL", "CRITICAL", "BLOCK", "email", 5),
